            ...
            <div class="col-sm-8">
                <form action="" method="post" enctype="mutlipart/form-data">
                    <table class="table table-bordered table-hover">
                        <tr align="center">
                            <td colspan="6" class="active"><h2>Change Your Account Settings</h2></td>
                        </tr>
                        <tr>
                                                ...
                                                <?php
                                                    ...
                                                    if (isset($_POST['sub'])) {
                                                        ...
                                                        if ($bfn=="") {
                                                            ...
                                                            echo "<script>window.open('accouunt_settings.php', '_self')</script>";
                                                            exit();
                                                        }
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <a class="btn btn-default" style="text_decoration: none; font-size: 15px" href="change_password.php"><i class="fa fa-key fa-fw" aria-hidden="true"></i>Change Password</a>
                            </td>
                        </tr>
                        <tr align="center">
                            <td colspace="6">
                ...
                <?php
                    ...
                    if (isset($_POST['update'])) {
                        ...
                        $update = "UPDATE users SET user_name='$user_name', user_email='$email', user_country='$u_country' WHERE user_email='$user'";
